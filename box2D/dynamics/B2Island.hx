...
class B2Island
{
	...
	public function initialize(bodyCapacity:Int, contactCapacity:Int, jointCapacity:Int, allocator:Dynamic, listener:B2ContactListener,
	...
	public function solve(step:B2TimeStep, gravity:B2Vec2, allowSleep:Bool):Void
	{
		...
		for (i in 0...m_bodyCount)
		{
			...
			if (b.getType() != DYNAMIC_BODY) continue;
		...
		for (i in 0...m_bodyCount)
		{
			...
			if (b.getType() == STATIC_BODY) continue;
