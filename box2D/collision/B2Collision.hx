...
class B2Collision
{
	...
	static public function edgeSeparation(poly1:B2PolygonShape, xf1:B2Transform, edge1:Int, poly2:B2PolygonShape, xf2:B2Transform):Float
	{
	...
	// from poly1.
	static public function findMaxSeparation(edgeIndex:Array<Int>, poly1:B2PolygonShape, xf1:B2Transform, poly2:B2PolygonShape, xf2:B2Transform):Float
	{
		var count1:Int = poly1.m_vertexCount;
		var normals1:Array<B2Vec2> = poly1.m_normals;
	...
	static public function findIncidentEdge(c:Array<ClipVertex>, poly1:B2PolygonShape, xf1:B2Transform, edge1:Int, poly2:B2PolygonShape, xf2:B2Transform):Void
	{
		var count1:Int = poly1.m_vertexCount;
		var normals1:Array<B2Vec2> = poly1.m_normals;
	...
	static public function collidePolygons(manifold:B2Manifold, polyA:B2PolygonShape, xfA:B2Transform, polyB:B2PolygonShape, xfB:B2Transform):Void
	{
		var cv:ClipVertex;
	...
	static public function collideCircles(manifold:B2Manifold, circle1:B2CircleShape, xf1:B2Transform, circle2:B2CircleShape, xf2:B2Transform):Void
	{
		manifold.m_pointCount = 0;
	...
	static public function collidePolygonAndCircle(manifold:B2Manifold, polygon:B2PolygonShape, xf1:B2Transform, circle:B2CircleShape, xf2:B2Transform):Void
	{
		manifold.m_pointCount = 0;
